...
namespace Duska.Screens
{
    public class PongGameScreen : GameScreen
    {
        ...
        public PongGameScreen(Game game, string usuario)
            : base(game)
        {
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            if (keyboardState.WasKeyReleased(Keys.Escape))
                ScreenManager.LoadScreen(new MainMenuScreen(Game, usuario), new ExpandTransition(GraphicsDevice, Color.Black));
